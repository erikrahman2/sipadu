...
<div class="space-y-6">
  ...
  <div class="bg-gradient-to-r from-primary-dark to-primary rounded-2xl p-6 text-white shadow-lg">
    ...
    <p class="text-blue-200 mt-1">
      <?php echo e(auth()->user()->institution?->name ?? 'Sistem SiPadu'); ?>
      ...
      ?>
      <span class="bg-white/20 rounded-full px-2 py-0.5 text-xs font-medium"><?php echo e($roleLabel); ?></span>
    </p>
  </div>
  ...
  <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 flex items-center gap-4">
      <div class="w-12 h-12 rounded-xl bg-<?php echo e($card['color']); ?>-100 flex items-center justify-center">
        <i class="fas <?php echo e($card['icon']); ?> text-<?php echo e($card['color']); ?>-500 text-xl"></i>
      </div>
      <div>
        <p class="text-2xl font-bold text-gray-800"><?php echo e($card['value']); ?></p>
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
    ...
    <?php if (\Illuminate\Support\Facades\Blade::check('role', 'pa_assistant')): ?>
      ...
      <a href="<?php echo e(route('dashboard.cases')); ?>"
    ...
    <?php if (\Illuminate\Support\Facades\Blade::check('role', 'pa_management')): ?>
      <a href="<?php echo e(route('dashboard.cases')); ?>?status=OCR_PROCESSED"
      ...
      <a href="<?php echo e(route('dashboard.cases')); ?>?status=PA_REVIEW"
    ...
    <?php if (\Illuminate\Support\Facades\Blade::check('role', 'pa_staff')): ?>
      <a href="<?php echo e(route('dashboard.cases')); ?>?status=COMPLETED"
      ...
      <a href="<?php echo e(route('dashboard.upload')); ?>"
         class="bg-white border border-gray-200 rounded-2xl p-6 flex items-center gap-4 hover:border-green-400 hover:bg-green-50 transition">
    ...
    <?php if (\Illuminate\Support\Facades\Blade::check('role', 'disdukcapil_staff')): ?>
      <a href="<?php echo e(route('dashboard.cases')); ?>?status=DISDUKCAPIL_VALIDATION"
    ...
    <?php if (\Illuminate\Support\Facades\Blade::check('role', 'super_admin')): ?>
      ...
      <a href="<?php echo e(route('dashboard.admin.audit')); ?>"
         class="bg-white border border-gray-200 rounded-2xl p-6 flex items-center gap-4 hover:border-primary hover:bg-blue-50 transition">
      ...
      <a href="<?php echo e(route('dashboard.admin.logs')); ?>"
         class="bg-white border border-gray-200 rounded-2xl p-6 flex items-center gap-4 hover:border-primary hover:bg-blue-50 transition">
  ...
  <div class="bg-white rounded-2xl shadow-sm border border-gray-100">
    <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
      ...
      <a href="<?php echo e(route('dashboard.cases')); ?>" class="text-sm text-primary hover:underline">Lihat semua →</a>
    </div>
        ...
        <tbody class="divide-y divide-gray-100">
          ...
          <tr class="hover:bg-blue-50/40 transition">
            ...
            <td class="px-4 py-3 font-mono text-xs text-primary">
              <?php echo e($item->source_type === 'case' ? Str::limit($item->case_number, 20) : Str::limit($item->tracking_token, 20)); ?>

            </td>
            <td class="px-4 py-3">
              <?php echo e($item->source_type === 'case' ? ($item->petitioner_name ?? '-') : ($item->applicant_name ?? '-')); ?>

            </td>
            <td class="px-4 py-3">
              <?php echo $__env->make('components.status-badge', ['status' => $item->status], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </td>
            <td class="px-4 py-3 text-gray-500 text-xs"><?php echo e($item->updated_at->diffForHumans()); ?></td>
            <td class="px-4 py-3">
              <?php if($item->source_type === 'case'): ?>
                <a href="<?php echo e(route('dashboard.cases.show', $item->id)); ?>"
                   class="text-primary hover:underline text-xs font-medium">
                  <i class="fas fa-eye mr-1"></i>Review
                </a>
              <?php else: ?>
                <a href="<?php echo e(route('dashboard.public-inbox.show', $item->id)); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ProyekTA\resources\views/dashboard/index.blade.php ENDPATH**/ ?>