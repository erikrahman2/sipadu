...
<div class="max-w-3xl">
  ...
  <form method="POST" action="{{ route('dashboard.admin.cms.kelola-konten.blog.store') }}" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden divide-y divide-gray-100">
    @csrf
