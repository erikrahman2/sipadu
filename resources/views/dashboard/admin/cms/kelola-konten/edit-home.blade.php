...
<form action="{{ route('kelola-konten.home.update', $section->id) }}" method="POST" enctype="multipart/form-data"
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="secondary_cta_url" value="{{ old('secondary_cta_url', $section->secondary_cta_url) }}"
                       class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-primary/30 focus:border-primary outline-none">
