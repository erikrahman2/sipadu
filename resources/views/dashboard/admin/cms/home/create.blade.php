...
@section('breadcrumb')
  ...
  <a href="{{ route('dashboard.admin.cms.home.index') }}" class="text-gray-500 hover:text-gray-700">Section Beranda</a>
  <i class="fas fa-chevron-right text-xs"></i>
...
@section('content')
<div class="max-w-3xl">
  <a href="{{ route('dashboard.admin.cms.home.index') }}" class="text-sm text-primary hover:underline mb-4 inline-block">
    <i class="fas fa-arrow-left mr-1"></i> Kembali
  </a>

  <form method="POST" action="{{ route('dashboard.admin.cms.home.store') }}" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden divide-y divide-gray-100">
    @csrf
    ...
    <div class="px-4 py-4 bg-gray-50 flex items-center justify-end gap-3">
      <a href="{{ route('dashboard.admin.cms.home.index') }}" class="px-4 py-2 text-sm text-gray-600 hover:text-gray-800 transition">Batal</a>
