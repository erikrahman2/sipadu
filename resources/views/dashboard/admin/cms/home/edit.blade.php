...
@section('title', 'Edit Section Beranda')
@section('page-title', 'Edit Section Beranda')
...
<div class="max-w-3xl">
  ...
  <form method="POST" action="{{ route('dashboard.admin.cms.home.update', $section) }}" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden divide-y divide-gray-100">
    @csrf @method('PATCH')
    ...
    <div class="p-4 space-y-4">
      <div>
        ...
        <p class="text-xs text-gray-400 mt-1">Kunci tidak dapat diubah.</p>
      </div>
      ...
      <div class="grid grid-cols-2 gap-4">
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1">Label Tombol</label>
