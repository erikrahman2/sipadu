...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('cms_home_sections', function (Blueprint $table) {
            ...
            $table->string('cta_label', 100)->nullable()->after('image_path');
            $table->string('cta_url', 255)->nullable()->after('cta_label');
            $table->unsignedInteger('display_order')->default(0)->after('cta_url');
    ...
    public function down(): void
    {
        Schema::table('cms_home_sections', function (Blueprint $table) {
            ...
            $table->dropColumn([
                'section_key', 'title', 'subtitle', 'content', 'image_path',
                'cta_label', 'cta_url', 'display_order', 'is_active', 'updated_by',
            ]);
        });
    }
};
